        ...
        <div className="relative h-full w-full flex-none">
            ...
            <ScrollShadow orientation="horizontal" className="-mx-2 -mb-4 mt-4 flex w-full max-w-full gap-4 px-2 pb-4 pt-2">
                {images?.map((img, index) => (
                    <Button key={index} className="w-24 h-24 p-0 data-[selected=true]:ring-primary data-[selected=true]:outline-none data-[selected=true]:ring-2 data-[selected=true]:ring-focus data-[selected=true]:ring-offset-2" data-selected={selected === index}>
