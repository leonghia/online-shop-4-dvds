...
export function Google({ className }: any) {
    return (
        <svg className={cn(className)} viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function Facebook({ className }: any) {
    return (
        <svg className={cn(className)} xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 40 40">
